...
post1 = pd.read_pickle('./BayesianResults/posterior_n2000_PriorsTable1')
...
cutY = pd.read_pickle('./PerformanceTestPickles/cutY')
...
if __name__ == '__main__':
    ...
    x = hardWrapper(post1.median(), Z.copy(), T.copy(), Q.copy(), H.copy(), R.copy(), y.T.copy(), coefsIndex)

    # parallel = True
    #
    # if not parallel:
    #     priorsTable = pd.read_excel('./BayesianResults/PriorsTable1.xlsx')
    #     MH(priorsTable, Z, T, Q, H, R, y, coefsIndex, n, 'priors1')
    #
    #     priorsTable = pd.read_excel('./BayesianResults/PriorsTable2.xlsx')
    #     MH(priorsTable, Z, T, Q, H, R, y, coefsIndex, n, 'priors2')
    #
    # if parallel:
